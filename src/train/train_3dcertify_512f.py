#!/usr/bin/env python3
"""
Train PointNet with 3DCertify architecture using 64 points and 512 features.
This matches alpha-beta-CROWN configuration for fair comparison.
"""
...
# Config - matching alpha-beta-CROWN for fair comparison
NUM_POINTS = 64
NUM_CLASSES = 2
MAX_FEATURES = 512  # Same as alpha-beta-CROWN
BATCH_SIZE = 32
EPOCHS = 50
LR = 0.001
...
print("=" * 70)
print("Training PointNet (3DCertify Architecture) - 512 Features")
print("=" * 70)
...
train_groups = np.load(BASE_DIR / "data/pointnet/train_groups.npy")
...
# Create model - 3DCertify architecture with 512 features
print("Creating PointNet model (3DCertify architecture, 512 features)...")
model = PointNet(
    number_points=NUM_POINTS,
    num_classes=NUM_CLASSES,
    max_features=MAX_FEATURES,  # 512 instead of 1024
...
for epoch in range(1, EPOCHS + 1):
    ...
    if test_acc > best_acc:
        ...
        torch.save(
            ...
            BASE_DIR / "saved_models/pointnet_3dcertify_512f.pth",
        )
...
print(f"Model saved to: saved_models/pointnet_3dcertify_512f.pth")
print("=" * 70)
